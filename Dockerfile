# FinBrief Financial News Crawler - Production Dockerfile
...
LABEL maintainer="FinBrief Team" \
      version="1.0.0" \
      description="FinBrief Financial News Crawler and Analysis System" \
...
RUN rm -rf tests/ debug/ *.md requirements-docker.txt \
